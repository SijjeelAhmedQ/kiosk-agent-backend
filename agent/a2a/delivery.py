...
browser to ask for a location and no person to type one. So the drop is the
customer's saved address (`agent/location.saved()`), and that is the whole of the
...
async def hand_over(order: dict[str, Any]) -> dict[str, Any] | None:
